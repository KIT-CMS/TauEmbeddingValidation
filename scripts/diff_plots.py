...
plotting_instructions = [
    ...
    {"col":"LJ_pt",           
        ...
        "rel_bins":np.linspace(0, 3, nbins),      
        "title":r"$p_\text{T, LJet, emb}$ - $p_\text{T, LJet, data}$",              
        "rel_title":r"$(p_\text{T, LJet, emb}$ - $p_\text{T, LJet, data})$ / $p_\text{T, LJet, data}$",              
        "relative":False,
        "ylog":True,    
        "xlog":False},
    {"col":"LM_eta",             
    ...
    #     "bins":np.linspace(0, 150, nbins),      
    #     "rel_bins":np.linspace(0, 3, nbins),      
    #     "title":r"$p_\text{T, TJet, emb}$ - $p_\text{T, TJet, data}$",              
    #     "rel_title":r"$(p_\text{T, TJet, emb}$ - $p_\text{T, TJet, data})$ / $p_\text{T, TJet, data}$",              
    #     "relative":False,
    #     "ylog":True,    
    #     "xlog":False},
    {"col":"TM_eta",             
